...
const displayProducts = (productsData) => {
    ...
    for(const val in productsData){
        ...
        node_A.setAttribute("href", "./product.html?id="+productsData[val]._id)
